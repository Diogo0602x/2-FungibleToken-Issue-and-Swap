...
import net.corda.samples.tokenizedhouse.contracts.CassinoTokenStateContract;
...
@BelongsToContract(CassinoTokenStateContract.class)
public class FungibleCassinoTokenState extends EvolvableTokenType {
    ...
    public FungibleCassinoTokenState(int valuation, Party maintainer,
    ...
    public boolean equals(Object o) {
        ...
        FungibleCassinoTokenState that = (FungibleCassinoTokenState) o;
